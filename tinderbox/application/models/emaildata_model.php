...
class EmailData_Model extends CI_Model
{
	var $table = "tblEmail";
	var $pk = "emailId";
	var $ds = "emailTimeStamp";  //Default sortby field
	var $rq = "emailTo";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'emailToName' => array('label'=>'To Name','type'=>'varchar','constraint'=>200),
		 'emailFrom' => array('label'=>'From','type'=>'int','constraint'=>200),
         'emailFromName' => array('label'=>'From Name','type'=>'int','constraint'=>200),
         'emailMessage' => array('label'=>'Message','type'=>'int','constraint'=>200),
		);
